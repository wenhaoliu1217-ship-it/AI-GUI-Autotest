...
export const api = {
  ...
  async startAgentRun(plan: TestPlan, draft: TestCaseDraft, settings: AISettings, projectId?: string, scenarioId?: string, environmentId?: string, enableVisualFallback = false): Promise<TestRun> {
