...
class FailureCategory(str, Enum):
    ...
    BUSINESS_STATE = "business_state"  # 后台业务状态未达成或发生非法跃迁
    UNKNOWN = "unknown"
...
class StepResult(BaseModel):
    ...
    browser_context_evidence: Optional[dict] = None
    commerce_state_evidence: Optional[dict] = None
...
class RunResult(BaseModel):
    ...
    commerce_summary: Optional[dict[str, Any]] = None
    runner_isolation: Optional[dict[str, Any]] = None
    result_classification: str = "unverified"
    model_data_authorization: Optional[dict[str, Any]] = None
