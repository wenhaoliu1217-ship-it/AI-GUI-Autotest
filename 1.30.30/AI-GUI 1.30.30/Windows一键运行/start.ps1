...
$runnerImage = 'ai-gui-runner:1.30.30'
$runnerArchives = @(
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.30.30.tar'),
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.30.30.tar.gz'),
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.30.30.tgz')
)
