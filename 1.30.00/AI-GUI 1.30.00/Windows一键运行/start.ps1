...
$runnerImage = 'ai-gui-runner:1.30.00'
$runnerArchives = @(
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.30.00.tar'),
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.30.00.tar.gz'),
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.30.00.tgz')
)
