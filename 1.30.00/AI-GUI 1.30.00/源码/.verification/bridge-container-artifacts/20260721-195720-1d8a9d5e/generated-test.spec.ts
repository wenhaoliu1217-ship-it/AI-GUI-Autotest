...
test("real container bridge verification", async ({ page }) => {
  await test.step("步骤 1", async () => {
    await page.goto("http://host.docker.internal:62445/");
  });
  await test.step("Select entity Alpha through Bridge", async () => {
