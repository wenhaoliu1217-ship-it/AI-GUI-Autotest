...
def test_browser_diagnostics_detect_reviewable_layout_and_blank_page_signals() -> None:
    with sync_playwright() as playwright:
        ...
        page.set_content("""
          ...
          <input placeholder="请输入租户" data-qa="tenant-input" />
          <div role="row" data-object-id="agent-42">E2E_Agent</div>
        ...
        assert "placeholder=请输入租户" in summary
        assert "data-qa=tenant-input" in summary
        assert "data-object-id=agent-42" in summary
