...
- 运行 ID：`20260722-040942-26a18c1b`
- 总体状态：**通过**
- 基础地址：http://127.0.0.1:64365
- 开始：2026-07-22T04:09:42.139656+08:00
- 结束：2026-07-22T04:09:44.392389+08:00
- 耗时：2252 ms
- 退出码：0
...
| # | 动作 | 目标 | 状态 | 耗时(ms) | 说明 |
|---|------|------|------|----------|------|
| 1 | navigate | navigate -> / | 通过 | 434 |  |
| 2 | visual_click | 视觉定位并执行 click：Canvas 目标 @ css=#map | 通过 | 495 | 视觉定位并执行 click：Canvas 目标 |
