...
- 运行 ID：`20260722-041021-1430c41f`
- 总体状态：**错误**
- 基础地址：http://127.0.0.1:64850
- 开始：2026-07-22T04:10:21.087331+08:00
- 结束：2026-07-22T04:10:23.149513+08:00
- 耗时：2062 ms
- 退出码：1
...
| # | 动作 | 目标 | 状态 | 耗时(ms) | 说明 |
|---|------|------|------|----------|------|
| 1 | navigate | navigate -> / | 通过 | 508 |  |
| 2 | bridge_click | Select entity Alpha @  | 错误 | 440 | 当前环境未启用 App Bridge，拒绝执行 app_bridge 动作 |
...
- 证据时间线：
  - 2026-07-22T04:10:22.767335+08:00 · before_action；截图 `screenshots/step-2-before.png`
    - 页面：无标题 · http://127.0.0.1:64850/
  - 2026-07-22T04:10:22.990359+08:00 · after_action；截图 `screenshots/step-2-after-failure.png`
    - 页面：无标题 · http://127.0.0.1:64850/
    - collectionStatus="failed"
    - failurePhase="stability"
    - error="当前环境未启用 App Bridge，拒绝执行 app_bridge 动作"
