...
- 运行 ID：`20260722-043020-65405f9c`
- 总体状态：**通过**
- 基础地址：http://127.0.0.1:61629
- 开始：2026-07-22T04:30:20.751473+08:00
- 结束：2026-07-22T04:30:23.264891+08:00
- 耗时：2513 ms
- 退出码：0
...
| # | 动作 | 目标 | 状态 | 耗时(ms) | 说明 |
|---|------|------|------|----------|------|
| 1 | navigate | navigate -> / | 通过 | 528 |  |
| 2 | visual_click | 视觉定位并执行 click：Canvas 目标 @ css=#map | 通过 | 542 | 视觉定位并执行 click：Canvas 目标 |
