...
$runnerImage = 'ai-gui-runner:1.31.00'
$runnerArchives = @(
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.31.00.tar'),
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.31.00.tar.gz'),
  (Join-Path $dockerArchiveRoot 'ai-gui-runner-1.31.00.tgz')
)
