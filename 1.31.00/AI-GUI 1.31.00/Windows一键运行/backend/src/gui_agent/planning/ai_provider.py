...
def _post_vision_probe(settings: AISettings) -> dict[str, Any]:
    # One opaque red pixel: sufficient to verify image transport without sending site data.
    image = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAusB9Y9Z4x8AAAAASUVORK5CYII="
