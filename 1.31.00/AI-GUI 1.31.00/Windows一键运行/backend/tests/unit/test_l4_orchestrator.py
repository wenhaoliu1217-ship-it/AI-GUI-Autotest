...
def workflow() -> dict:
    return {"stages": [
        {"id": "create", "requiredOutputs": ["businessId"]},
        {"id": "configure", "dependsOn": ["create"], "requiredOutputs": ["configurationId"]},
        {"id": "start", "dependsOn": ["configure"], "requiredOutputs": ["simulationRunId"]},
        {"id": "wait", "dependsOn": ["start"], "requiredOutputs": ["terminalState"]},
        {"id": "verify", "dependsOn": ["wait"], "requiredOutputs": ["evidenceId"]},
    ]}
