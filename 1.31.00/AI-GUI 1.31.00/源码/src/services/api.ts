...
export const api = {
  ...
  async startAgentRun(draft: TestCaseDraft, settings: AISettings, modelDataAuthorization: { siteHost: string; allowDom: boolean; allowScreenshots: boolean }, projectId?: string, scenarioId?: string, environmentId?: string, enableVisualFallback = false): Promise<TestRun> {
