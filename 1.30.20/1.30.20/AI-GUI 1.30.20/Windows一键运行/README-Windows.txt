京彩OPC AI GUI 自动化测试平台（1.30.00 离线便携交付版）
...
使用：
1. 双击 start.bat。
2. 首次运行会从包内离线归档加载 ai-gui-runner:1.30.00；已经存在时直接复用。
...
3. runtime/images/ai-gui-runner-1.30.00.tar：离线 Runner 镜像归档；也接受 .tar.gz 或 .tgz。
